...
class_names = ['SA','LA','SL','PC','DM','BL','JB','RA','SLA','SRA','CL']  # 类别名，依次写下来
dirpath = r'E:/yolov7-main/cymeo/train/Annotations/'  # 原来存放xml文件的目录
newdir = r'E:/yolov7-main/cymeo/output/'  # 修改label后形成的txt目录
