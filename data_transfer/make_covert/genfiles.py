...
def convert_annotation(image_id):
    in_file = open('E:/yolor-main/TT100K/VOCdevkit/VOC2007/Annotations/%s.xml' % image_id)
    out_file = open('E:/yolor-main/TT100K/VOCdevkit/VOC2007/labels/%s.txt' %image_id, 'w')
