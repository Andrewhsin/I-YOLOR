...
# GT image path & csv
train_path = 'E:/yolor-main/yolor-main/bdd100k/train/images/'  # training圖片路徑 (training label一樣是把images改成labels的路徑)
val_path = 'E:/yolor-main/yolor-main/bdd100k/val/images/'  # validation圖片 (val label一樣是把images改成labels的路徑)
save_img_path = 'E:/yolor-main/yolor-main/bdd100k/new_labels/'  # 儲存改名後並轉檔成jpg的圖片路徑
